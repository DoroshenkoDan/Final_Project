import cartReducer, {
  ...
  describe('cartReducer', () => {
    ...
    it('should increment the quantity of an item in the cart', () => {
      ...
      const nextState = cartReducer(initialState, incrementQuantity(itemIdToIncrement));
    ...
    it('should decrement the quantity of an item in the cart', () => {
      ...
      const nextState = cartReducer(initialState, dicrementQuantity(itemIdToDecrement));
