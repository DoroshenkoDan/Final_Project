...
import { removeFromCart, incrementQuantity, dicrementQuantity } from "../../Redux/reducers/cartReducer";
import { useDispatch } from "react-redux";
export default function CartProductList({ img, name, quantity, price, discribe, id }) {
    ...
    return (
        <div className={styles["cart-product-container"]}>
            <img className={styles["delete-icon"]} src={deleteIcon} onClick={() => dispatch(removeFromCart(id))} />
