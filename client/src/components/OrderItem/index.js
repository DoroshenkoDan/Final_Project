...
export default function OrderPage(props) {
    ...
    return (
        <>
            <h2 className={`${styles['order-num']} ${styles['order-text']}`}>Order: № {props.order.orderNo}</h2>
            <p className={`${styles['order-sum']} ${styles['order-text']}`}>Total Sum: {props.order.totalSum}$</p>
            {
            ...
            <span className={styles['btn-close']} onClick={deleteOrders}><CloseBtnIcon></CloseBtnIcon></span>
        </>
    )
}
