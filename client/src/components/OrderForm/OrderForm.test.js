...
describe('OrderForm', () => {
    ...
    it('submits the form with valid data', async () => {
        render(<OrderForm changeOrderPlaced={mockChangeOrderPlaced}
                          orderPlaced={mockOrderPlaced}/>);
        ...
        await act(async () => {
            ...
            fireEvent.change(screen.getByPlaceholderText('Email'), {target: {value: 'useremail@gmail.com'}})
            fireEvent.change(screen.getByPlaceholderText('Mobile'), {target: {value: '0500123456'}})
            fireEvent.change(screen.getByPlaceholderText('Country'), {target: {value: 'Ukraine'}})
            fireEvent.change(screen.getByPlaceholderText('City'), {target: {value: 'Kyiv'}})
            fireEvent.change(screen.getByPlaceholderText('Address'), {target: {value: 'Bankovskaya street'}})
            fireEvent.change(screen.getByPlaceholderText('Postal'), {target: {value: '12345'}})
